<#
.SYNOPSIS
    Full upgrade script for complete development environment

.DESCRIPTION
    Upgrades all platform tools including Docker/WSL2 and development packages to their latest versions.
...
if ($isAdmin -and -not $AllowAdmin) {
    ...
    Write-Host "  .\Full-Upgrade.ps1 -AllowAdmin" -ForegroundColor White
    Write-Host ""
...
╔═══════════════════════════════════════════════════════════╗
║                                                           ║
║        Environment Bootstrap - Full Upgrade               ║
║                                                           ║
╚═══════════════════════════════════════════════════════════╝
...
Write-Host "  3. Restart Docker Desktop (if running)"
